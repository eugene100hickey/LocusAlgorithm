...
bibliography: libraries/library.bib
...
B <- score2(int.pts[max.index[1], "int_ra"] %>% as.numeric(), 
            int.pts[max.index[1], "int_dec"] %>% as.numeric())
